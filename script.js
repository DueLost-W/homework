function Mine(tr, td, mineNum) {
    ...
    this.tr = tr;   
    this.td = td; 
    this.mineNum = mineNum; //mineNum---雷的数量
    this.surplusMine = mineNum; //余雷的数量
    this.tds = []; 
    this.allRight = false; 
    this.parent = document.querySelector('.gameBox'); //querySelector() 方法返回文档中匹配指定 CSS 选择器的一个元素。
...
Mine.prototype.randomNum = function () {
    var square = new Array(this.tr * this.td); // 生成空数组，长度为格子总数
